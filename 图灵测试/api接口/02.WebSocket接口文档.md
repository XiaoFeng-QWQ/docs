...
| WebSocket 路径 | Handler | 前缀 | 说明 |
|---------------|---------|------|------|
| `/ws` | `GameWebSocketHandler` | 无 | "对面是AI吗" 主游戏 |
| `/ws/lobby` | `LobbyChatWebSocketHandler` | `lobby_` | 大厅聊天室 |
| `/ws/WhoisAI` | `WhoisAIWebSocketHandler` | `WhoisAI_` | "谁是AI" |
| `/ws/gomoku` | `GomokuWebSocketHandler` | `gomoku_` | 五子棋 |
| `/{adminPath}/ws` | `AdminWebSocketHandler` | — | 管理后台 |
